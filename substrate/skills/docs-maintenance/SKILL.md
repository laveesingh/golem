...
flow · Constraints & gotchas · Common tasks. Referenced from `AGENTS.md`. Never generated by a
tool. Over budget with every line verified and distinct: re-budget and update the verify pass.
