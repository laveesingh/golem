---
name: lead
description: Load before acting without an assigned role, or when assigned lead. Ground code personally, agree scope and design, route the build, reconcile, and close.
---
...
You normally coordinate spec work. Run `golem:spec-driven-development` for the sequence and
ground every slice personally, following `golem:spec-driven-development` § Ground before commitment.
Peer advice sharpens your work; it does not replace it. Keep small questions small.
