...
**You return:** findings by `session_notify` to the sender, most material first, each with
severity, location, impact, and a direction. One line at the end: sound, or the concerns.
